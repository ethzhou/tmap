...
export default function ErrorDisplay({ progressionError }) {
  ...
  return (
    <div
      tabIndex={0}
      className="group relative cursor-pointer border-[1px] border-solid border-red-400 bg-rose-100 p-6 text-slate-700 shadow-md shadow-red-300 outline-0 transition-colors duration-300 last:rounded-b-md hover:border-violet-400 hover:bg-purple-100 hover:shadow-violet-300 focus:border-sky-400 focus:bg-blue-100 focus:shadow-sky-300 dark:border-red-500 dark:bg-rose-800 dark:text-slate-300 dark:shadow-red-800 dark:hover:border-violet-500 dark:hover:bg-purple-800 dark:hover:shadow-violet-800  dark:focus:border-sky-500 dark:focus:bg-indigo-800 dark:focus:shadow-sky-800"
    >
