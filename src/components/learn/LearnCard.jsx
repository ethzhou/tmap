...
export default function LearnCard({ name, blurb, to, tags }) {
  return (
    <>
      <div className="learn-card group/card relative z-[2] flex border-0 border-l-2 border-solid border-sky-200 bg-slate-100 transition-all duration-500 before:pointer-events-none before:absolute before:inset-0 before:z-[3] before:h-full before:w-full before:opacity-0 before:transition-opacity before:duration-300 before:content-[''] after:absolute after:-left-[2px] after:top-[80%] after:h-0 after:w-[2px] after:rounded-bl-full after:opacity-0 after:transition-all after:duration-500 after:ease-out after:content-[''] hover:border-transparent hover:border-opacity-0 hover:before:opacity-100 hover:after:top-[10%] hover:after:h-[70%] hover:after:opacity-100 dark:border-slate-600 dark:bg-slate-800 dark:hover:border-transparent">
        <Link
          to={to}
